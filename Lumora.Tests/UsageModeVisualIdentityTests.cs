...
public sealed class UsageModeVisualIdentityTests
{
    ...
    public void Menu_demarrer_porte_le_profil_en_pied_de_menu()
    {
        ...
        // ET apres les vues Epingle/Categories/Recherche.
        var xaml = ReadRepoFile("Lumora.WinUI", "MainWindow.xaml");
    ...
    [Fact]
    public void Version_projet_est_alignee_sur_0_94_26_1()
    {
        var mainWindow = ReadRepoFile("Lumora.WinUI", "MainWindow.xaml.cs");
        ...
        Assert.Contains("0.94.26.1-dev", mainWindow, StringComparison.Ordinal);
        Assert.Contains("0.94.26.1-dev", agents, StringComparison.Ordinal);
        Assert.Contains("0.94.26.1-dev", cleanArtifactScript, StringComparison.Ordinal);
        Assert.Contains("0.94.26.1-dev", installerScript, StringComparison.Ordinal);
    }
