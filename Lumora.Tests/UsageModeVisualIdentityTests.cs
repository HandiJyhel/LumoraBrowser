...
public sealed class UsageModeVisualIdentityTests
{
    ...
    [Fact]
    public void Version_projet_est_alignee_sur_0_93_54_1()
    {
        var mainWindow = ReadRepoFile("Lumora.WinUI", "MainWindow.xaml.cs");
        ...
        Assert.Contains("0.93.54.1-dev", mainWindow, StringComparison.Ordinal);
        Assert.Contains("0.93.54.1-dev", agents, StringComparison.Ordinal);
        Assert.Contains("0.93.54.1-dev", cleanArtifactScript, StringComparison.Ordinal);
        Assert.Contains("0.93.54.1-dev", installerScript, StringComparison.Ordinal);
    }
