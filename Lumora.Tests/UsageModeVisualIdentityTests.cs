...
public sealed class UsageModeVisualIdentityTests
{
    ...
    [Fact]
    public void Version_projet_est_alignee_sur_0_94_3_0()
    {
        var mainWindow = ReadRepoFile("Lumora.WinUI", "MainWindow.xaml.cs");
        ...
        Assert.Contains("0.94.3.0-dev", mainWindow, StringComparison.Ordinal);
        Assert.Contains("0.94.3.0-dev", agents, StringComparison.Ordinal);
        Assert.Contains("0.94.3.0-dev", cleanArtifactScript, StringComparison.Ordinal);
        Assert.Contains("0.94.3.0-dev", installerScript, StringComparison.Ordinal);
    }
