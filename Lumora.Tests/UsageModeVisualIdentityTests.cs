...
public sealed class UsageModeVisualIdentityTests
{
    ...
    public void Version_projet_est_alignee_sur_0_83_22()
    {
        ...
        Assert.Contains("0.83.17-dev", mainWindow, StringComparison.Ordinal);
        Assert.Contains("0.83.17-dev", agents, StringComparison.Ordinal);
        Assert.Contains("0.83.17-dev", cleanArtifactScript, StringComparison.Ordinal);
        Assert.Contains("0.83.17-dev", installerScript, StringComparison.Ordinal);
    }
