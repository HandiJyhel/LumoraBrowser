...
public sealed class UsageModeVisualIdentityTests
{
    ...
    [Fact]
    public void Version_projet_est_alignee_sur_0_94_5_2()
    {
        var mainWindow = ReadRepoFile("Lumora.WinUI", "MainWindow.xaml.cs");
        ...
        Assert.Contains("0.94.5.2-dev", mainWindow, StringComparison.Ordinal);
        Assert.Contains("0.94.5.2-dev", agents, StringComparison.Ordinal);
        Assert.Contains("0.94.5.2-dev", cleanArtifactScript, StringComparison.Ordinal);
        Assert.Contains("0.94.5.2-dev", installerScript, StringComparison.Ordinal);
    }
