...
public sealed class NewTabMarkupTests
{
    ...
    [Fact]
    public void HtmlText_retombe_sur_Pulse_si_vide()
    {
        Assert.Equal("Pulse", NewTabMarkup.HtmlText(null));
        Assert.Equal("Pulse", NewTabMarkup.HtmlText("   "));
    }
    ...
    public void NormalizeShortcutUrl_laisse_les_schemas_connus_intacts()
    {
        ...
        Assert.Equal("pulse://settings", NewTabMarkup.NormalizeShortcutUrl("pulse://settings"));
    }
