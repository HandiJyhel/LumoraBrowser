...
public sealed partial class MainWindow
{
    ...
    private void DismissLoginOverlay()
    {
        ...
        // (stockage 100% maison → vault.pulse est le seul magasin).
    ...
    private void SkipProfileButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        Title = $"Pulse Browser {Version} — Mode invité";
    }
    ...
    private async void ProfileLocationContinueButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        else
        {
            ...
            cfg.ActiveProfileId = PulseProfilePaths.NormalizeProfileId(_pendingProfileId);
            cfg.Save();
        }
        ...
        if (Directory.Exists(targetProfile.NavigationDir))
            foreach (var f in Directory.GetFiles(targetProfile.NavigationDir, "*.pulse"))
                File.Delete(f);
    ...
    private async void ForgotPasswordButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            Text = "La cle de recuperation reste locale. Sans cette cle, Pulse Browser ne peut pas contourner le chiffrement.",
    ...
    private async Task ShowRecoveryKeyDialogAsync(string recoveryKey)
    {
        ...
        panel.Children.Add(new TextBlock
        {
            Text = "Notez cette cle maintenant. Elle permet de recuperer le profil et le coffre si le mot de passe est oublie. Pulse Browser ne peut pas la retrouver a votre place.",
            TextWrapping = TextWrapping.Wrap
        });
        ...
        var dialog = new ContentDialog
        {
            Title = "Cle de recuperation Pulse",
            Content = panel,
    ...
    private async void ResetProfileButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        // Supprimer tout le dossier de profil (navigation, vault, favicons, profile.pulse)
